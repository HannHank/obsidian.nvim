...
> [!NOTE]
>- open Zotero links via Obsidian.nvim smartActions (see [zotcite](https://github.com/jalvesaq/zotcite))
>- new command **:ObsidianTodayMerge** $\to$ merges unfinished tasks from yesterday into today's journal. 
